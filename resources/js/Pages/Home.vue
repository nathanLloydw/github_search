<template>
    <div class="bg-[#242d3c] w-full sticky top-0 shadow-2xl">
        <div class="py-2 flex flex-wrap max-w-4xl mx-auto">
            ...
            <svg v-if="this.searching" class="inline mr-2 w-8 h-8 text-gray-200 animate-spin fill-purple-600 my-auto" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
